...
import com.byfreakdevs.fitme.databinding.FragmentDashboard2Binding
...
//            val foodDao = ItemDatabase.getDatabase(requireContext()).getItemDao()
        ...
        binding.btGetCaloriesDashboard.setOnClickListener {
            ...
            viewModel.foodList.observe(viewLifecycleOwner , Observer { list ->
                ...
                val bundle = Bundle()
                bundle.putDouble("key", 10.0) // Put anything what you want
...
//                    .beginTransaction()
//                    .replace(R.id.content, reportsFragment)
//                    .commit()
//
